...
export default function FetchProducts() {
  ...
  return (
    <>
      <section className="px-5 py-10 lg:py-20 xl:max-w-6xl xl:mx- grid grid-cols-1 gap-5 lg:gap-10 xl:gap-20">
        {items.products.map(({ id, name, desc, small, large }) => (
          <article
            key={id}
            className="grid grid-cols-1 gap-5 md:grid-cols-2 md:place-items-center lg:gp-10 xl:gp-20"
          >
            <div>
              <picture>
            ...
            <div>
              ...
              <ul className="flex items-center justify-between">
                ...
                <li>
                  <button className="bg-white text-slate-800 py-2 px-4">
                    Add to Cart
                  </button>
                </li>
              </ul>
